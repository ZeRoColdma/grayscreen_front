...
import BotaoParadas from "./components/NovaParada/index";
import BotaoParadasTrimming from "./components/NovaParadaTrimming/index";
                ...
                >
                  <div className="card-body">
                    <h5 className="card-title">
                      Informe de Paradas Porto Norte
                    </h5>
